...
EPISODES = {
    1: {
        'en': 'Contact',
        'ja': 'デジャブ',
        'desc': '退屈な日常の中、千花はスマートアイなしで町の内側に触れ、神田響と出会う。',
    },
    2: {
        'en': 'Log',
        'ja': 'ログ',
    ...
    3: {
        'en': 'Boundary',
        'ja': 'メモリーのあと',
        'desc': '報告書の余韻。旧体育館の不在。職員室で、倒れたことが別の言葉に変わる。',
    },
    4: {
        'en': 'Cracking Sandbox',
        'ja': 'ひびく Sandbox',
        'desc': '日常の箱庭にひびが入る。家で、千花の世界が音を立てて崩れ落ちる。',
    },
    5: {
        'en': 'Aporia',
        'ja': '行き詰まり',
        'desc': '止まらない町。神田の救出。木村と赤いバイクの脱出。千花は家へ戻れなくなる。',
    },
    6: {
        'en': 'Existential Exodus',
        'ja': '実存のエクソダス',
        'desc': '雷鳥に収容された千花は、合流済みの綾を想いながら、未確定の接続核と瑠璃見を離れる痛みを抱えて夜空へ向かう。',
    },
    7: {
        'en': 'Boundary Noise',
        'ja': '境界のノイズ',
        'desc': '瑠璃見サーバー施設からの接続ノイズに引き戻される千花は、御厨玲奈の助言で「窓」を作る術を知る。',
    },
    8: {
        'en': 'Red Wing',
        'ja': '赤い翼のペンダント',
    ...
    9: {
        'en': 'Black File',
        'ja': '黒いファイル',
        'desc': '旧郷土資料館で黒塗りの紙記録を発見し、千花はカイの声と瑠璃見サーバー施設を結ぶ線に触れる。',
    },
    10: {
        'en': 'Phase Two',
        'ja': 'フェーズ2',
    ...
    11: {
        'en': 'Araki Record',
        'ja': '荒木紘一の記録',
        'desc': '荒木の告発記録は、事故、救命、実験、そして瑠璃見サーバー施設を物理停止するアナログハッチの存在を示す。',
    },
    12: {
    ...
    13: {
        ...
        'ja': '旧体育館の底',
        'desc': '旧体育館の床下に隠された同期観測線が、箱庭の記憶と瑠璃見サーバー施設を物理的につなげていた。',
    },
    14: {
        'en': 'Kai Lawrence',
        'ja': 'カイ・ローレンス',
        'desc': 'IKAROS領域の縁で千花はカイと再会し、彼が作られた存在でありながら自ら空を望んだことを知る。',
    },
    15: {
        'en': 'The Whole Incident',
        'ja': '事件の全貌',
        'desc': '紺虹峠の事故と隠蔽の真相が明かされ、千花はカイを鎖にしないためIKAROS領域を切り離す決断へ進む。',
    },
    16: {
        'en': 'Rurimi Uprising',
        'ja': '瑠璃見動乱',
        'desc': '瑠璃見サーバー施設停止後も町の暴走は止まらず、千花は力を兵器ではなく避難誘導の道標として使い始める。',
    },
    17: {
        'en': 'Analog Hatch',
        'ja': 'アナログハッチの守人',
